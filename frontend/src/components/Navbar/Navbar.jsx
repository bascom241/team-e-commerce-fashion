    ...
    <>
      <div className="flex justify-between  px:2 sm:py-4 sm:px-16 items-center ">
        ...
        <div>
          <ul className="sm:flex gap-2 items-center hidden">
            ...
            <Link>
              <FaRegHeart className="text-white bg-black p-1 rounded-lg w-8 h-8 flex items-center justify-center cursor-pointer border-2 transform transition-all duration-300 hover:text-black hover:bg-white border-transparent hover:border-black" />
            </Link>
            <Link to="profile">
              <BsPersonFillCheck className="text-white bg-black p-1 rounded-lg w-8 h-8 flex items-center justify-center cursor-pointer hover:text-black hover:bg-white hover:border-black transform transition-hover duration-300 border-2 border-transparent" />
            </Link>
          </ul>
      ...
      <div>
        <ul className="flex justify-center items-center gap-14 py-2">
          <NavLink className="hover:text-black/40" to="/">
            Home
          </NavLink>
